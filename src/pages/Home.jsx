...
export default function Home({ posts = [] }) {
  ...
  return <main id="main-content" tabIndex={-1} className="home-page editorial-home">
    <section className="editorial-opening" aria-labelledby="opening-question">
      ...
      <div className="editorial-welcome"><p>I’m Ritwik, a cloud and platform engineer. I write about AI, reliable systems, and the decisions behind them.</p><p className="editorial-aside">A perfectly reasonable place to overthink.</p><a className="essay-link" href="/blog">Explore the writing <span aria-hidden="true">↗</span></a></div>
    </section>
